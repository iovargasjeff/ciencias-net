...
it('calculates tardiness and justified and unjustified absence discount formulas', function () {
    ...
    $this->actingAs($manager)
        ...
        ->postJson('/api/v1/payroll-liquidations', [
...
it('closes liquidations transactionally and blocks recalculation after closure', function () {
    ...
    $this->actingAs($manager)
        ->postJson("/api/v1/payroll-liquidations/{$liquidationId}/closure")
        ->assertOk()
...
it('queues payroll reports and validates authorization and errors', function () {
    ...
    $this->postJson('/api/v1/payroll-liquidations', [
        'period_start' => '2026-06-01',
        'period_end' => '2026-06-30',
    ])->assertUnauthorized();
    ...
    $this->actingAs($manager)
        ...
        ->postJson('/api/v1/teacher-attendance/reports', [
            'period_start' => '2026-06-01',
            'period_end' => '2026-06-30',
            'format' => 'xlsx',
            'teacher_ids' => [$teacher->id],
    ...
    $this->actingAs($manager)
        ->postJson('/api/v1/payroll-liquidations/00000000-0000-7000-8000-000000000000/closure')
        ->assertForbidden();
