...
## Implementation
- [x] 1.1 Crear casos de uso individual/masivo. Owner: Jefferson
- [x] 1.2 Validar puntajes y estados. Owner: Jefferson
- [x] 1.3 Implementar preview y transacción. Owner: Jefferson
- [x] 1.4 Auditar correcciones. Owner: Jefferson

## Verification
- [x] 2.1 Verificar que carga ajena bloqueada. Owner: Jefferson
- [x] 2.2 Verificar que importación inválida revierte. Owner: Jefferson
- [x] 2.3 Verificar que estados no reciben puntaje indebido. Owner: Jefferson
