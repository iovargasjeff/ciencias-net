...
## Implementation
- [ ] 1.1 Implementar publicación transaccional. Owner: Jefferson
- [ ] 1.2 Calcular ranking excluyendo estados. Owner: Jefferson
- [ ] 1.3 Crear consultas y reportes PDF. Owner: Jefferson
- [ ] 1.4 Notificar panel/correo y auditar corrección. Owner: Jefferson

## Verification
- [ ] 2.1 Verificar que privacidad alumno/padre pasa. Owner: Jefferson
- [ ] 2.2 Verificar que empates y exclusiones pasan. Owner: Jefferson
- [ ] 2.3 Verificar que corrección recalcula y notifica. Owner: Jefferson
