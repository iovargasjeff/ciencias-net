...
luego abona una cuota mensual por la infraestructura y el soporte.
...
CienciasNET puede replicarse para otros colegios del Perú. El primer cliente (Colegio Ciencias) valida el producto en
producción real. A partir del segundo cliente el tiempo de desarrollo se reduce significativamente y el equipo puede
evaluar:
